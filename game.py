...
class BOSS(Scene):
    ...
    def enter(self):
        ...
        def surikens():
            global direction
            print("Он стреляет 3 сюрекена!")
            time.sleep(1)
            print("1. Отойти максимально влево.")
            print("2. Отойти максимально вправо.")
            print("3. Упасть.")
            print("4. Уклониться вправо - влево - вправо.")
            print("5. Уклониться влево - вправо - влево.")
            print("6. Подпрыгнуть.")
            direction = input("> ")
            time.sleep(1)
            if direction == "1":
                print("Он так умело их стрелял! Но только не в твою сторону!")
                input()
            else:
        ...
        input()
        print("Разработчик перестарался!!")
        time.sleep(1.5)
        print("""
        ``````````````__....-----------...__
``````````.--'```````````````````````--.
